    ...
    <div class="container d-flex flex-column justify-content-between vh-100">
                    ...
                    <div class="card-header bg-primary">
                        <div class="app-brand">
                            <a href="{{ route('dashboard') }}">
                                ...
                                <span class="brand-name">basic-x Dashboard</span>
                            </a>
                        </div>
                    </div>
                    @if (session('status'))
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12 mb-4">
                                    <input type="email" name="email" class="form-control input-lg" i
        ...
        <div class="copyright pl-0">
            <p class="text-center">&copy; 2022 Copyright
                <a class="text-primary" href="http://fashion-flux.vercel.app" target="_blank">Isaac</a>.
            </p>
        </div>
    </div>
</body>
